...
namespace DenizenMetaWebsite.MetaObjects {
    public class WebsiteMetaProcedure : WebsiteMetaObject<MetaProcedure> {
        public override void LoadHTML() {
            ...
            HtmlContent += TableLine("default", "Returns", $"<a href=\"https://meta.denizenscript.com/Docs/ObjectTypes/{Util.EscapeForHTML(Object.Returns.Before('('))}\">{Util.EscapeForHTML(Object.Returns)}</a>", false);
        ...
        public override string GroupingString => Object.Script;
    }
}
